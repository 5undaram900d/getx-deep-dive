...
//
//     final tvShowModel59 = tvShowModel59FromJson(jsonString);

import 'dart:convert';

TvShowModel59 tvShowModel59FromJson(String str) => TvShowModel59.fromJson(json.decode(str));

String tvShowModel59ToJson(TvShowModel59 data) => json.encode(data.toJson());
...
class TvShowModel59 {
  ...
  factory TvShowModel59.fromJson(Map<String, dynamic> json) => TvShowModel59(
    total: json["total"],
    page: json["page"],
    pages: json["pages"],
